 ...
 */
public class RunningOrderActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        Request<JSONObject> request = new PostRequest(Net.URL_SHIPPER_GET_ORDER_DETAIL,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        Log.d(RunningOrderActivity.class.getName(), jsonObject.toString());
                        try {
                            if (ShipperService.getResult(jsonObject)) {
                                ...
                                if (order.getState()==4) {
                                    ...
                                    order_state.setText("司机已经抢单，订单正在进行中");
                                    state_iv.setImageDrawable(getResources().getDrawable(R.drawable.order_running));
...
//                        }
                ...
                break;
            default:
                Log.e(RunningOrderActivity.class.getName(), "Unknown id");
        }
    }
